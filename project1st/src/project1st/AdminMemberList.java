...
public class AdminMemberList extends JFrame {
	...
	public void mainGui() {
		...
		JButton btnok_1 = new JButton("중복확인");
		btnok_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnok_1.setFont(new Font("함초롬돋움", Font.PLAIN, 12));
		btnok_1.setEnabled(false);
		btnok_1.setBackground(SystemColor.menu);
		btnok_1.setBounds(255, 53, 81, 23);
		panel_1.add(btnok_1);
		
		JButton btnok_1_1 = new JButton("수정");
		btnok_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnok_1_1.setFont(new Font("함초롬돋움", Font.PLAIN, 12));
		...
		btnok.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (tfinid.getText().equals("")) {
					JOptionPane.showMessageDialog(getContentPane(), "아이디를 입력하세요", "Information",
							JOptionPane.INFORMATION_MESSAGE);
...
//					tfinpwd.setText((String) infolist[0][1]);
					...
					if(((String) infolist[0][5]).equals("남")) {
						rbtngender.setSelected(true);
						rbtngender1.setSelected(false);
					}else if(((String) infolist[0][5]).equals("여")) {
						rbtngender.setSelected(false);
